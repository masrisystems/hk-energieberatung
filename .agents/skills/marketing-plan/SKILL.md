---
name: marketing-plan
description: When the user needs a comprehensive marketing plan (growth plan, GTM plan, 90-day plan, fractional-CMO plan) for a client, a company they advise, or their own product. Generates an exhaustive AARRR-structured plan customized to the client's budget, team, and stage, cross-referenced with the marketing-ideas library and a current-state audit rubric, as a Notion-paste-ready document. For positioning and ICP context before planning, see product-marketing. For stage-specific deep work, see onboarding, signup, emails, referrals, pricing.
---
