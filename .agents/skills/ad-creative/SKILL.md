---
name: ad-creative
description: "When the user wants to generate, iterate, or scale ad creative — headlines, descriptions, primary text, or full ad variations (RSAs, static ads, motion/video hooks, chat-style ads) — for any paid advertising platform, or wants creative testing/roadmap/review work. Use whenever someone needs to produce ad copy at scale or iterate on existing ads. For campaign strategy and targeting, see ads. For landing page copy, see copywriting."
metadata:
  version: 2.8.0
---
