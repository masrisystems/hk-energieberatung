...
description: "When the user wants help with public relations, earned media, press coverage, or journalist outreach (not pull requests) — press releases, media lists/kits, HARO-style reporter requests, newsjacking, or thought leadership placement. Use this for earned media work — finding journalists, pitching stories, newsjacking, and responding to press requests. For startup/SaaS/AI directory submissions, see directory-submissions. For product launches, see launch. For social-media engagement, see social. For cold-email outreach to prospects, see cold-email."
metadata:
  version: 1.0.0
---
